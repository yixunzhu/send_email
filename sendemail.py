...
if __name__ == "__main__":
    mailto_list = ["test@bintools.cn"]
    htmlpath = '/TestResult/自动化测试报告_2023-05-01_11-34-35.html'
    send_html_report(mailto_list, u"自动化测试报告", htmlpath)
